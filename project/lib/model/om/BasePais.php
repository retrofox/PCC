...
/**
 * Base class that represents a row from the 'geo_pais' table.
 *
 * 
 *
...
abstract class BasePais extends BaseObject  implements Persistent {
  ...
  const PEER = 'PaisPeer';
	...
	/**
	 * @var        array Provincia[] Collection to store aggregation of Provincia objects.
	 */
	protected $collProvincias;

	/**
	 * @var        Criteria The criteria used to select the current contents of collProvincias.
	 */
	...
	public function setCodigo($v)
	{
		...
		if ($this->codigo !== $v) {
			$this->codigo = $v;
			$this->modifiedColumns[] = PaisPeer::CODIGO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = PaisPeer::NUM_COLUMNS - PaisPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PaisPeer::CODIGO)) $criteria->add(PaisPeer::CODIGO, $this->codigo);
	...
	/**
	 * Clears out the collProvincias collection (array).
	 *
	...
	/**
	 * Initializes the collProvincias collection (array).
	 *
	...
	/**
	 * Gets an array of Provincia objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Pais has previously been saved, it will retrieve
	 * related Provincias from storage. If this Pais is new, it will return
		...
		if ($this->collProvincias === null) {
			if ($this->isNew()) {
			   $this->collProvincias = array();
				...
				$criteria->add(ProvinciaPeer::PAIS_ID, $this->id);
	...
	public function addProvincia(Provincia $l)
	{
		...
		if (!in_array($l, $this->collProvincias, true)) { // only add it if the **same** object is not already associated
			array_push($this->collProvincias, $l);
			$l->setPais($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Pais has previously been saved, it will retrieve
	 * related UserProfiles from storage. If this Pais is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collUserProfiles === null) {
			if ($this->isNew()) {
			   $this->collUserProfiles = array();
				...
				$criteria->add(UserProfilePeer::NACIONALIDAD, $this->id);
