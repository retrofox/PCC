...
abstract class BasesfGuardUserProfilePeer {
	...
	const LANGUAGE = 'sf_guard_user_profile.LANGUAGE';
	...
	const FDN = 'sf_guard_user_profile.FDN';
	...
	const DOCUMENTO_TIPO = 'sf_guard_user_profile.DOCUMENTO_TIPO';

	/** the column name for the DOCUMENTO_NUMERO field */
	const DOCUMENTO_NUMERO = 'sf_guard_user_profile.DOCUMENTO_NUMERO';

	/** the column name for the CUIL field */
	const CUIL = 'sf_guard_user_profile.CUIL';

	/** the column name for the LEGAJO field */
	const LEGAJO = 'sf_guard_user_profile.LEGAJO';
	...
	const DOMICILIO_CALLE = 'sf_guard_user_profile.DOMICILIO_CALLE';

	/** the column name for the DOMICILIO_NUMERO field */
	const DOMICILIO_NUMERO = 'sf_guard_user_profile.DOMICILIO_NUMERO';

	/** the column name for the DOMICILIO_MANZANA field */
	const DOMICILIO_MANZANA = 'sf_guard_user_profile.DOMICILIO_MANZANA';

	/** the column name for the DOMICILIO_BARRIO field */
	const DOMICILIO_BARRIO = 'sf_guard_user_profile.DOMICILIO_BARRIO';

	/** the column name for the DOMICILIO_PISO field */
	const DOMICILIO_PISO = 'sf_guard_user_profile.DOMICILIO_PISO';

	/** the column name for the DOMICILIO_DEPTO field */
	const DOMICILIO_DEPTO = 'sf_guard_user_profile.DOMICILIO_DEPTO';

	/** the column name for the LOCALIDAD_ID field */
	const LOCALIDAD_ID = 'sf_guard_user_profile.LOCALIDAD_ID';

	/** the column name for the PROVINCIA_ID field */
	const PROVINCIA_ID = 'sf_guard_user_profile.PROVINCIA_ID';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::LANGUAGE);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::NOMBRE);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::APELLIDO);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::FDN);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::NACIONALIDAD);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::DOCUMENTO_TIPO);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::DOCUMENTO_NUMERO);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::CUIL);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::LEGAJO);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::TELEFONO);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::MOVIL);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::EMAIL);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::DOMICILIO_CALLE);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::DOMICILIO_NUMERO);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::DOMICILIO_MANZANA);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::DOMICILIO_BARRIO);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::DOMICILIO_PISO);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::DOMICILIO_DEPTO);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::LOCALIDAD_ID);

		$criteria->addSelectColumn(sfGuardUserProfilePeer::PROVINCIA_ID);
	...
	public static function doCountJoinPais(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(sfGuardUserProfilePeer::NACIONALIDAD,), array(PaisPeer::ID,), $join_behavior);
	...
	public static function doCountJoinLocalidad(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(sfGuardUserProfilePeer::LOCALIDAD_ID,), array(LocalidadPeer::ID,), $join_behavior);
	...
	public static function doCountJoinProvincia(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(sfGuardUserProfilePeer::PROVINCIA_ID,), array(ProvinciaPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of sfGuardUserProfile objects pre-filled with their Pais objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of sfGuardUserProfile objects.
	...
	public static function doSelectJoinPais(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(sfGuardUserProfilePeer::NACIONALIDAD,), array(PaisPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (sfGuardUserProfile) to $obj2 (Pais)
				$obj2->addsfGuardUserProfile($obj1);
	...
	/**
	 * Selects a collection of sfGuardUserProfile objects pre-filled with their Localidad objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of sfGuardUserProfile objects.
	...
	public static function doSelectJoinLocalidad(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(sfGuardUserProfilePeer::LOCALIDAD_ID,), array(LocalidadPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (sfGuardUserProfile) to $obj2 (Localidad)
				$obj2->addsfGuardUserProfile($obj1);
	...
	/**
	 * Selects a collection of sfGuardUserProfile objects pre-filled with their Provincia objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of sfGuardUserProfile objects.
	...
	public static function doSelectJoinProvincia(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(sfGuardUserProfilePeer::PROVINCIA_ID,), array(ProvinciaPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (sfGuardUserProfile) to $obj2 (Provincia)
				$obj2->addsfGuardUserProfile($obj1);
      ...
      call_user_func($callable, 'BasesfGuardUserProfilePeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (sfGuardUserProfile) to the collection in $obj3 (Pais)
			...
			if ($key4 !== null) {
				...
				// Add the $obj1 (sfGuardUserProfile) to the collection in $obj4 (Localidad)
			...
			if ($key5 !== null) {
				...
				// Add the $obj1 (sfGuardUserProfile) to the collection in $obj5 (Provincia)
      ...
      call_user_func($callable, 'BasesfGuardUserProfilePeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = sfGuardUserProfilePeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (sfGuardUserProfile) to the collection in $obj2 (Pais)
				$obj2->addsfGuardUserProfile($obj1);
				...
				// Add the $obj1 (sfGuardUserProfile) to the collection in $obj3 (Localidad)
				$obj3->addsfGuardUserProfile($obj1);
				...
				// Add the $obj1 (sfGuardUserProfile) to the collection in $obj4 (Provincia)
				$obj4->addsfGuardUserProfile($obj1);
	...
	/**
	 * Selects a collection of sfGuardUserProfile objects pre-filled with all related objects except Pais.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of sfGuardUserProfile objects pre-filled with all related objects except Localidad.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of sfGuardUserProfile objects pre-filled with all related objects except Provincia.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
