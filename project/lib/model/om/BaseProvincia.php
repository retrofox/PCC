...
/**
 * Base class that represents a row from the 'geo_provincia' table.
 *
 * 
 *
...
abstract class BaseProvincia extends BaseObject  implements Persistent {
  ...
  const PEER = 'ProvinciaPeer';
	...
	public function setPaisId($v)
	{
		...
		if ($this->pais_id !== $v) {
			$this->pais_id = $v;
			$this->modifiedColumns[] = ProvinciaPeer::PAIS_ID;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProvinciaPeer::PAIS_ID)) $criteria->add(ProvinciaPeer::PAIS_ID, $this->pais_id);
	...
	public function getPais(PropelPDO $con = null)
	{
		if ($this->aPais === null && ($this->pais_id !== null)) {
			...
			$c->add(PaisPeer::ID, $this->pais_id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Provincia has previously been saved, it will retrieve
	 * related UserProfiles from storage. If this Provincia is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collUserProfiles === null) {
			if ($this->isNew()) {
			   $this->collUserProfiles = array();
				...
				$criteria->add(UserProfilePeer::PROVINCIA_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Provincia has previously been saved, it will retrieve
	 * related Proveedors from storage. If this Provincia is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collProveedors === null) {
			if ($this->isNew()) {
			   $this->collProveedors = array();
				...
				$criteria->add(ProveedorPeer::PROVINCIA_ID, $this->id);
