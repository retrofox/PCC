...
abstract class BaseEstado extends BaseObject  implements Persistent {
  ...
  const PEER = 'EstadoPeer';
	 ...
	 * Indica el orden que puede tener un estado dentro de los diferentes estados
	 * @return     int
	 */
	 ...
	 * Define si es estado para una compra (0), venta (1), nota de pedido (2), etc
	 * @return     int
	 */
	...
	public function setOrden($v)
	{
		...
		if ($this->orden !== $v) {
			$this->orden = $v;
			$this->modifiedColumns[] = EstadoPeer::ORDEN;
		}
	...
	public function setTipo($v)
	{
		...
		if ($this->tipo !== $v) {
			$this->tipo = $v;
			$this->modifiedColumns[] = EstadoPeer::TIPO;
		}
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = EstadoPeer::DESCRIPCION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = EstadoPeer::NUM_COLUMNS - EstadoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EstadoPeer::ORDEN)) $criteria->add(EstadoPeer::ORDEN, $this->orden);
		if ($this->isColumnModified(EstadoPeer::TIPO)) $criteria->add(EstadoPeer::TIPO, $this->tipo);
		if ($this->isColumnModified(EstadoPeer::NOMBRE)) $criteria->add(EstadoPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(EstadoPeer::DESCRIPCION)) $criteria->add(EstadoPeer::DESCRIPCION, $this->descripcion);
	 ...
	 * related NotaPedidoEstados from storage. If this Estado is new, it will return
		...
		if ($this->collNotaPedidoEstados === null) {
			if ($this->isNew()) {
			   $this->collNotaPedidoEstados = array();
				...
				$criteria->add(NotaPedidoEstadoPeer::ESTADO_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Estado has previously been saved, it will retrieve
	 * related CompraEstados from storage. If this Estado is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCompraEstados === null) {
			if ($this->isNew()) {
			   $this->collCompraEstados = array();
				...
				$criteria->add(CompraEstadoPeer::ESTADO_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Estado has previously been saved, it will retrieve
	 * related VentaEstados from storage. If this Estado is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collVentaEstados === null) {
			if ($this->isNew()) {
			   $this->collVentaEstados = array();
				...
				$criteria->add(VentaEstadoPeer::ESTADO_ID, $this->id);
