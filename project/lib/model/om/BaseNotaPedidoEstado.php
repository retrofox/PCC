...
/**
 * Base class that represents a row from the 'nota_pedido_estado' table.
 *
 * 
 *
 ...
 */
abstract class BaseNotaPedidoEstado extends BaseObject  implements Persistent {


  const PEER = 'NotaPedidoEstadoPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        NotaPedidoEstadoPeer
	 */
	...
	/**
	 * Initializes internal state of BaseNotaPedidoEstado object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     NotaPedidoEstado The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = NotaPedidoEstadoPeer::ID;
		}
	...
	public function setNotaPedidoId($v)
	{
		...
		if ($this->nota_pedido_id !== $v) {
			...
			$this->modifiedColumns[] = NotaPedidoEstadoPeer::NOTA_PEDIDO_ID;
		}
	...
	public function setEstadoId($v)
	{
		...
		if ($this->estado_id !== $v) {
			$this->estado_id = $v;
			$this->modifiedColumns[] = NotaPedidoEstadoPeer::ESTADO_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = NotaPedidoEstadoPeer::USER_ID;
		}
	...
	public function setObservaciones($v)
	{
		...
		if ($this->observaciones !== $v) {
			...
			$this->modifiedColumns[] = NotaPedidoEstadoPeer::OBSERVACIONES;
		}
	...
	public function setFecha($v)
	{
		...
		if ( $this->fecha !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = NotaPedidoEstadoPeer::FECHA;
			}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = NotaPedidoEstadoPeer::CREATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->estado_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 7; // 7 = NotaPedidoEstadoPeer::NUM_COLUMNS - NotaPedidoEstadoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating NotaPedidoEstado object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = NotaPedidoEstadoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseNotaPedidoEstado:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			NotaPedidoEstadoPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseNotaPedidoEstado:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseNotaPedidoEstado:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(NotaPedidoEstadoPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseNotaPedidoEstado:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			NotaPedidoEstadoPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = NotaPedidoEstadoPeer::doInsert($this, $con);
					...
					$affectedRows += NotaPedidoEstadoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = NotaPedidoEstadoPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = NotaPedidoEstadoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = NotaPedidoEstadoPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setEstadoId($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NotaPedidoEstadoPeer::ID)) $criteria->add(NotaPedidoEstadoPeer::ID, $this->id);
		if ($this->isColumnModified(NotaPedidoEstadoPeer::NOTA_PEDIDO_ID)) $criteria->add(NotaPedidoEstadoPeer::NOTA_PEDIDO_ID, $this->nota_pedido_id);
		if ($this->isColumnModified(NotaPedidoEstadoPeer::ESTADO_ID)) $criteria->add(NotaPedidoEstadoPeer::ESTADO_ID, $this->estado_id);
		if ($this->isColumnModified(NotaPedidoEstadoPeer::USER_ID)) $criteria->add(NotaPedidoEstadoPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(NotaPedidoEstadoPeer::OBSERVACIONES)) $criteria->add(NotaPedidoEstadoPeer::OBSERVACIONES, $this->observaciones);
		if ($this->isColumnModified(NotaPedidoEstadoPeer::FECHA)) $criteria->add(NotaPedidoEstadoPeer::FECHA, $this->fecha);
		if ($this->isColumnModified(NotaPedidoEstadoPeer::CREATED_AT)) $criteria->add(NotaPedidoEstadoPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(NotaPedidoEstadoPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of NotaPedidoEstado (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     NotaPedidoEstado Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     NotaPedidoEstadoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new NotaPedidoEstadoPeer();
		}
		return self::$peer;
	}
	...
	public function getNotaPedido(PropelPDO $con = null)
	{
		if ($this->aNotaPedido === null && ($this->nota_pedido_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aNotaPedido->addNotaPedidoEstados($this);
			 */
		}
	...
	public function getEstado(PropelPDO $con = null)
	{
		if ($this->aEstado === null && ($this->estado_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aEstado->addNotaPedidoEstados($this);
			 */
		}
		return $this->aEstado;
	}
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUser->addNotaPedidoEstados($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseNotaPedidoEstado:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseNotaPedidoEstado::%s', $method));
    }
