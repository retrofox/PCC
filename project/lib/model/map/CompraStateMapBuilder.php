 ...
 */
class CompraStateMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.CompraStateMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(CompraStatePeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(CompraStatePeer::TABLE_NAME);
		$tMap->setPhpName('CompraState');
		$tMap->setClassname('CompraState');
