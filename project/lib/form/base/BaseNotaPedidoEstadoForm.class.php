...
/**
 * NotaPedidoEstado form base class.
 *
 * @package    pcc
 * @subpackage form
 ...
 */
class BaseNotaPedidoEstadoForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'             => new sfValidatorPropelChoice(array('model' => 'NotaPedidoEstado', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('nota_pedido_estado[%s]');
