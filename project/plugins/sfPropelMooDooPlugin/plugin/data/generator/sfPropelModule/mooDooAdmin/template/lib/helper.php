...
*/
  ...
  public function mooJsonDataToEditObject($object, $params)
  {
    ...
    if (isset($params['ajax_request'])) {
      ...
      return "{action: 'addWin', link: '".url_for($this->getUrlForAction('edit'), $object)."', link_content: '".url_for('<?php echo $this->getModuleName() ?>/editWinContent?<?php echo $this->getPrimaryKeyUrlParams() ?>)."', winClass: 'sfPropelEdit'},\n";
    }
    else {
  ...
  public function mooJsonDataToListObjects($object, $params)
  {
    ...
    if (isset($params['ajax_request'])) {
      ...
      return "{type: 'ajax_link', link: '".url_for('<?php echo $this->getModuleName() ?>')."', link_content: '".url_for('<?php echo $this->getModuleName() ?>/editWinContent?<?php echo $this->getPrimaryKeyUrlParams() ?>)."', update: '_new', winClass: 'sfPropelList'},\n";
    }
    else {
        return "{type: 'Guarda ACA !!'}";
    };
  ...
  public function mooJsonDataToNew($params, $cssClass='btn_admin_actions')
  {
    if (isset($params['inWinPopUp'])) {
      return "{type: 'ajax_link', link: '".url_for($this->getUrlForAction('new'))."', update: '_new', node_insert: 'embedded_win-<?php echo $this->getModuleName() ?>', winClass: 'sfPropelNew'},\n";
    }
    else {
    };
  }
