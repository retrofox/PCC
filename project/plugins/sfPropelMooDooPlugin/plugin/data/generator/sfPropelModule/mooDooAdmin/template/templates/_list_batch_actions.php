...
<?php endif; ?>
  <?php /* FIXME: ACM -> <input type="submit" value="[?php echo __('go', array(), 'sf_admin') ?]" /> */ ?>
  <div class="btn110" id="sf_admin_batch_actions_choice_go"><div class="icn icn-submit"></div>[?php echo __('go', array(), 'sf_admin') ?]</div>
</li>
<?php endif; ?>