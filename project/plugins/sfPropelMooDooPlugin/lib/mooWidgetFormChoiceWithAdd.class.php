...
/*
 * Este archivo es parte del plugin MooDoo
 * (c) Damian Suarez <damian.suarez@symfonias.com.ar>
 * 
...
/**
 * mooWidgetFormChoiceWithAdd represents a choice widget.
 *
 * @package    symfony
 * @subpackage widget
 ...
 * @version    1.0
 */
class mooWidgetFormChoiceWithAdd extends sfWidgetForm
{
  /**
   * Constructor.
   *
   ...
   *
   *  * choices:          Un array de opciones (requerido)
   *  * multiple:         true si el tag select debe permitir multiples selecciones
