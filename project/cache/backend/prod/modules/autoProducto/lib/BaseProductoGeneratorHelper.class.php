 ...
 */
class BaseProductoGeneratorHelper extends sfModelGeneratorHelper
{
...
*/
  ...
  public function getUrlForAction($action, $module = '')
  {
    $module_action = $module ? $module : 'producto';
  ...
  {
    $producto = $object;
    return "{type: 'close_and_reedit', link: '".url_for($this->getUrlForAction('edit'), $object)."', link_content: '".url_for('producto/editWinContent?id='.$producto->getId())."'},\n";
  }
}