...
<ul class="sf_admin_bar_menu">
  <li class="btn110" id="btnFilterOn"><div class="icn icn-filter"></div><?php echo __('filter') ?></li>
    <?php echo moo_btn_to_filters(__('Reset', array(), 'sf_admin'), 'producto_collection', array('action' => 'filter')) ?>
...
<div class="sf_admin_filter">
  <div id="sf_admin_filter_slide">
	  ...
	  <?php endif; ?>
    <form id ="sf_admin_filter_form" action="<?php echo url_for('producto_collection', array('action' => 'filter')) ?>" method="post">
